...
/* harmony import */ var _ImageUploader_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ImageUploader.vue */ "./resources/js/components/ImageUploader.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ImageUploader: _ImageUploader_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  methods: {
    getData: function () {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/hosts/")["catch"](function (error) {
    ...
    onFileChanged: function () {
      var _onFileChanged = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("http://127.0.0.1:8000/fileUpload", formData);
      ...
      function onFileChanged(_x) {
        return _onFileChanged.apply(this, arguments);
      }
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("/hosts/", this.form)["catch"](function (error) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a["delete"]("/hosts/" + id)["catch"](function (error) {
                  return console.log(error);
                });
    ...
    onReservations: function () {
      var _onReservations = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/hosts/".concat(id, "/reservations/"));
      ...
      function onReservations(_x3) {
        return _onReservations.apply(this, arguments);
      }

      return onReservations;
    }(),
    imageUploaded: function imageUploaded($path, index) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onReserve: function onReserve(id) {
      localStorage.setItem('heureka_data', JSON.stringify(_objectSpread({}, this.form, {}, {
        start: "".concat(this.form.day, " ").concat(this.form.start, ":00"),
        end: "".concat(this.form.day, " ").concat(this.form.end, ":00")
    ...
    hasFreeTable: function hasFreeTable(host) {
      var _this = this;
      ...
      var goodTables = host.free_tables.filter(function (table) {
        return table.nr_of_chairs >= _this.form.persons;
      });
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/hosts/search", {
                  params: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("http://127.0.0.1:8000/fileUpload", formData);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.form = _objectSpread({}, this.form, {}, JSON.parse(localStorage.getItem('heureka_data')));
  },
  methods: {
    onSubmit: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/hosts/".concat(this.$route.params.id, "/reserve"), this.form);
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/reservations/".concat(this.$route.params.id), this.form);
        ...
        return _c("li", { key: host.id }, [
          _vm._v(
            "\n      " +
              ...
              _vm._s(host.id) +
              ") " +
              _vm._s(host.tables.length) +
              " " +
              _vm._s(
                host.tables.reduce(function(sum, table) {
                  return sum + table.nr_of_chairs
                }, 0)
              ) +
              "\n      "
          ),
          ...
          _c(
            "button",
            {
              on: {
                click: function($event) {
                  return _vm.onReservations(host.id)
                }
              }
            },
            [_vm._v("Reservations")]
          ...
          _c("div", [
            _vm._v(
              "\n        " +
                ...
                _vm._s(res.end) +
                " " +
                _vm._s(res.table.nr_of_chairs) +
                "\n        "
            ),
            res.status == "pending"
              ? _c("button", [_vm._v("Accept")])
              : _vm._e(),
            _vm._v(" "),
            res.status == "pending"
              ? _c("button", [_vm._v("Decline")])
              : _vm._e(),
            _vm._v(" "),
            res.status !== "pending"
              ? _c("div", [_vm._v(_vm._s(res.status))])
              : _vm._e()
          ])
        ])
      }),
  ...
  return _c(
    ...
    [
      ...
      _vm.errors.logo
        ? _c(
            "span",
            _vm._l(_vm.errors.logo, function(error) {
              return _c("span", [_vm._v(_vm._s(error))])
            }),
            0
          )
            ...
            _c("image-uploader", {
              ...
              on: {
                imageUploaded: function(path) {
                  return _vm.imageUploaded(path, index)
                },
                imageRemoved: function($event) {
                  return _vm.imageRemoved(index)
                }
              }
            })
          ],
      ...
      _vm._v(" "),
      _c("button", { on: { click: _vm.onAdd } }, [_vm._v("Add Host")]),
      _vm._v(" "),
      _c("br"),
      _vm._v(" "),
      _c("pre", [
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "home" } }, [
    ...
    _vm.errors.search
      ? _c(
          "span",
          _vm._l(_vm.errors.search, function(error) {
            return _c("span", [_vm._v(_vm._s(error))])
          }),
          0
        )
    ...
    _c("input", {
      ...
      attrs: { type: "date", placeholder: "add day" },
    ...
    _c("input", {
      ...
      attrs: { type: "time", placeholder: "add start time" },
    ...
    _c("input", {
      ...
      attrs: { type: "time", placeholder: "add end time" },
    ...
    _c("input", {
      ...
      attrs: { min: "1", type: "number", placeholder: "persons" },
    ...
    _vm.errors.persons
      ? _c(
          "span",
          _vm._l(_vm.errors.persons, function(error) {
            return _c("span", [_vm._v(_vm._s(error))])
          }),
          0
        )
    ...
    _c("br"),
    _vm._v(" "),
    _c("button", { on: { click: _vm.onSearch } }, [_vm._v("Search")]),
    _vm._v(" "),
    _c(
      "ul",
      _vm._l(_vm.hosts, function(host) {
        return _c("li", { key: host.id }, [
          _vm._v(
            "\n      " +
              ...
              _vm._s(host.id) +
              ") " +
              _vm._s(host.free_tables.length) +
              " " +
              _vm._s(
                host.free_tables.reduce(function(sum, table) {
                  return sum + table.nr_of_chairs
                }, 0)
              ) +
              "\n      "
          ),
          _vm.hasFreeTable(host)
            ? _c(
                "button",
                {
                  on: {
                    click: function($event) {
                      return _vm.onReserve(host.id)
                    }
                  }
                },
                [_vm._v("Reserve")]
...
var render = function() {
  ...
  return _c("div", [
    _c("label"),
    _vm._v(" "),
    _c("input", { attrs: { type: "file" }, on: { change: _vm.onFileChanged } }),
    _vm._v(" "),
    _vm.path
      ? _c("img", {
          attrs: { src: "storage/" + _vm.path, height: "42", width: "42" }
        })
      : _vm._e(),
    _vm._v(" "),
    _c(
  ...
  return _c("div", { attrs: { id: "res" } }, [
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _vm.errors.email ? _c("span") : _vm._e(),
        _vm._v(" "),
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _vm._v("\n    Summary " + _vm._s(_vm.$route.params.id) + "\n\n    "),
    _c("pre", [_vm._v("        " + _vm._s(_vm.summary) + "\n    ")])
  ])
}
var staticRenderFns = []
render._withStripped = true
...
/* harmony import */ var _components_Reservation_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Reservation.vue */ "./resources/js/components/Reservation.vue");
/* harmony import */ var _components_Summary_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/Summary.vue */ "./resources/js/components/Summary.vue");
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: "/admin",
    name: "admin",
    component: _components_Admin_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  }, {
    path: "/",
    name: "search",
    ...
    path: "/reservation/:id",
    name: "reservation",
    component: _components_Reservation_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  }, {
    path: "/summary/:id",
    name: "summary",
    component: _components_Summary_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  }]
}));
...
/***/ 0:
/*!*********************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/sass/normalize.scss ./resources/sass/app.scss ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/albertlaszlo/Heureka/new_project/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /Users/albertlaszlo/Heureka/new_project/resources/sass/normalize.scss */"./resources/sass/normalize.scss");
module.exports = __webpack_require__(/*! /Users/albertlaszlo/Heureka/new_project/resources/sass/app.scss */"./resources/sass/app.scss");
